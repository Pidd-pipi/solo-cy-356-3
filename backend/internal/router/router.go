...
type Router struct {
	...
	plotMemberHandler *handler.PlotMemberHandler
	plotInvitationHandler *handler.PlotInvitationHandler
...
func New(
	...
	return &Router{
		...
		plotMemberHandler: plotMemberHandler, plotInvitationHandler: plotInvitationHandler,
...
func (r *Router) Build() *gin.Engine {
	...
	r.registerUsers(v1)
	r.registerPlots(v1)
	r.registerPlotMembers(v1)
	r.registerPlotInvitations(v1)
